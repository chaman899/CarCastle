...
$ret="SELECT * FROM booking where (:startdate BETWEEN date(StartDate) and date(EndDate) || :enddate BETWEEN date(StartDate) and date(EndDate) || date(StartDate) BETWEEN :startdate and :enddate) and CarId=:vhid";
$query1 = $dbh -> prepare($ret);
$query1->bindParam(':vhid',$vhid, PDO::PARAM_STR);
$query1->bindParam(':startdate',$fromdate,PDO::PARAM_STR);
$query1->bindParam(':enddate',$todate,PDO::PARAM_STR);
$query1->execute();
...
$sql="INSERT INTO  booking(userEmail,CarId,StartDate,EndDate,Status) VALUES(:useremail,:vhid,:startdate,:enddate,:status)";
$query = $dbh->prepare($sql);
$query->bindParam(':useremail',$useremail,PDO::PARAM_STR);
$query->bindParam(':vhid',$vhid,PDO::PARAM_STR);
$query->bindParam('startdate',$fromdate,PDO::PARAM_STR);
$query->bindParam(':enddate',$todate,PDO::PARAM_STR);
...
$sql = "SELECT cars.* from cars where cars.id=:vhid";
$query = $dbh -> prepare($sql);
$query->bindParam(':vhid',$vhid, PDO::PARAM_STR);
$query->execute();
        ...
        <div class="listing_more_info">
          <!-- <div class="listing_detail_wrap">  -->
            ...
            <!-- <ul class="nav nav-tabs gray-bg" role="tablist">
              <h4><span class="col-md-9 col-md-push-5">Trip Details</span></h4> -->
...
<?php }} ?>
      ...
      <!--Side-Bar-->
      <aside class="col-md-5 col-md-push-3">
        ...
        <div class="sidebar_widget">
          ...
          <form method="post">
            <div class="form-group">
              ...
              <input type="date" class="form-control" name="startdate" placeholder="From Date" required>
            </div>
            <div class="form-group">
              <label>End Date:</label>
              <input type="date" class="form-control" name="enddate" placeholder="To Date" required>
            </div>
            <!-- <div class="form-group">
