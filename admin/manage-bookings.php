						...
						<div class="panel panel-primary">
							...
							<?php if($error){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } 
								...
								<table class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
									...
									<?php $sql = "SELECT users.FullName,brands.BrandName,cars.CarName,booking.StartDate,booking.EndDate,booking.CarId as vid,booking.Status,booking.PostingDate,booking.id  from booking join cars on cars.id=booking.CarId join users on users.EmailId=booking.userEmail join brands on cars.BrandId=brands.id  ";
$query = $dbh -> prepare($sql);
$query->execute();
...
{				?>	
										<tr>
											...
											<td><a href="edit-vehicle.php?id=<?php echo htmlentities($result->vid);?>"><?php echo htmlentities($result->BrandName);?> , <?php echo htmlentities($result->CarName);?></td>
