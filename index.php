...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      <h2>Find the Right <span>CarForYou</span></h2>
      <p>Rent cars for self drive in Bengaluru. <b>CarCastle</b> is the most preferred brand for self drive car rentals in Bengaluru. Self drive car rentals options are getting extremely popular in Bengaluru. Rent a car and enjoy the freedom to drive on your own with <b>CarCastle</b>.</p>
    </div>
    <div class="row">
  ...
  <div class="container div_zindex">
    <div class="row">
      ...
      <div class="col-lg-3 col-xs-6 col-sm-3">
        <div class="fun-facts-m">
          <div class="cell">
            <h2><i class="fa fa-car" aria-hidden="true"></i>24x7</h2>
            <p>Service</p>
          </div>
        </div>
      </div>
