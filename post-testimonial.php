...
$sql="INSERT INTO  feedback(UserEmail,Comments) VALUES(:email,:comments)";
    ...
    <div class="row">
      ...
      <div class="col-md-6 col-sm-8">
        <div class="profile_wrap">
          <h5 class="uppercase underline">Give us your feedback</h5>
          ...
          <form  method="post">
            ...
            <div class="form-group">
              ...
              <textarea class="form-control white_bg" name="comments" rows="4" required=""></textarea>
            </div>
